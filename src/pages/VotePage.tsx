...
const VotePage = () => {
  ...
  const messageData = {
    id: voteId,
    content: "🚨 URGENT: New COVID variant spreads through 5G towers! Share this with everyone you know to protect them! Government is hiding the truth! 📡🦠",
    timestamp: "2024-01-15 14:30",
    sender: "Unknown WhatsApp User",
    screenshot: "https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?w=400&h=300&fit=crop", // Placeholder screenshot
    aiNote: {
      summary: "This message contains multiple false claims linking COVID-19 to 5G technology, which has been thoroughly debunked by health organizations worldwide. The message uses urgency tactics typical of misinformation campaigns.",
      references: [
  ...
  const categories = [
    "Scam", "Satire", "Illicit", "Misleading", "False", "Spam", "Legitimate"
  ];

  const availableTags = [
    "Health", "Politics", "Finance", "Technology", "Urgent", "Chain Message"
  ];
    ...
    <div className="p-4 max-w-md mx-auto space-y-4">
      ...
      <Card>
        <CardHeader className="pb-3">
          ...
          <p className="text-xs text-gray-500">Received: {messageData.timestamp}</p>
        </CardHeader>
