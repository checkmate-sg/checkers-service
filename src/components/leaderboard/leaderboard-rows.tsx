...
export function LeaderboardRows({ entries, currentUserId }: LeaderboardRowsProps) {
  let lastRank = 0;
        ...
        return (
          <Fragment key={entry._id}>
            ...
            >
              ...
              <TableCell className="p-4">
                <span className="text-sm text-muted-foreground">{entry.numberOfVotes}</span>
              </TableCell>

              <TableCell className="p-4">
                <span className="text-sm text-muted-foreground">{entry.accuracy.toFixed(0)}</span>
              </TableCell>
              ...
              <TableCell className="p-4">
                <span className="text-sm font-bold">{entry.totalScore.toFixed(0)}</span>
              </TableCell>
            </TableRow>
          </Fragment>
        );
