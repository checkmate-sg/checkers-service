          ...
          <TooltipProvider delayDuration={0}>
            <Tooltip>
              ...
              <TooltipContent className="bg-card-foreground z-50 max-w-xs p-3 rounded-md">
                <div className="text-sm font-medium text-card">{Prop.tooltipHeader}</div>
      ...
      <CardContent className="space-y-3">
        {!Prop.isPercentageTarget && (
          <div className="flex items-baseline justify-between text-sm text-primary">
            ...
            <div className="font-medium">{targetString}</div>
          </div>
        )}
        {Prop.isPercentageTarget && (
        ...
        <div className="relative w-full p-1">
          <Progress value={progressValue} className={barColor} />
          {Prop.isPercentageTarget && (
            <div
