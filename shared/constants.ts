...
export const MIN_DAILY_VOTES = 5;
...
// MAX_DAILY_VOTES unambiguously marks a receive-all checker. 100 is a practical
// stand-in for "all" — exceeding it daily is unlikely.
export const MAX_DAILY_VOTES = 100;
